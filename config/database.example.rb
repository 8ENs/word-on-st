...
database_name = case Padrino.env
  when :development then 'word_on_st_development'
  when :production  then 'word_on_st_production'
  when :test        then 'word_on_st_test'
end
...
#     sessions:
#       default:
#         database: word_on_st_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: word_on_st_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: word_on_st_test
#         hosts:
#           - localhost:27017
#
#
